@{
    ...
    PrivateData          = @{
        PSData = @{
            ...
            Tags = @("adcs", "pki", "windows", "server", "certificate", "maintenance");

            # A URL to the license for this module.
            # LicenseUri = '';

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/System-Admins/adcstoolbox';
    ...
    HelpInfoURI = 'https://github.com/System-Admins/adcstoolbox';
